function [TrainingTime, TestingTime, TrainingAccuracy, TestingAccuracy,...
    InputWeight, BiasofHiddenNeurons, OutputWeight] =...
...
%% If Elm_Type = Classification, Preprocess the dataset
...
%% Calculate the training cputime
start_time_train=cputime;

%% Calculate weights & biases which is related to the Hidden Output Matrix H
